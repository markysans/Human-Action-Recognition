...
filename = 'person20_running_d4_uncomp.avi'
...
if len(img_array) >= 20:
    ...
    out = cv2.VideoWriter('/home/arijitiiest/Desktop/Workspace/Project/Human Action Recognition/MyWork/NewData/running/'+filename, 0, 25, (64, 128))
